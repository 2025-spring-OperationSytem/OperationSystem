...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3e5:	0f b6 91 2c 08 00 00 	movzbl 0x82c(%ecx),%edx
...
free(void *ap)
{
 ...
 5e8:	a1 48 08 00 00       	mov    0x848,%eax
 ...
 6b3:	a3 48 08 00 00       	mov    %eax,0x848
}
 6b8:	90                   	nop
 6b9:	c9                   	leave
 6ba:	c3                   	ret
...
morecore(uint nu)
{
 ...
 711:	83 c4 10             	add    $0x10,%esp
  return freep;
 714:	a1 48 08 00 00       	mov    0x848,%eax
}
 719:	c9                   	leave
 71a:	c3                   	ret
...
malloc(uint nbytes)
{
 ...
 72d:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 730:	a1 48 08 00 00       	mov    0x848,%eax
 735:	89 45 f0             	mov    %eax,-0x10(%ebp)
 738:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 73c:	75 23                	jne    761 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 73e:	c7 45 f0 40 08 00 00 	movl   $0x840,-0x10(%ebp)
 745:	8b 45 f0             	mov    -0x10(%ebp),%eax
 748:	a3 48 08 00 00       	mov    %eax,0x848
 74d:	a1 48 08 00 00       	mov    0x848,%eax
 752:	a3 40 08 00 00       	mov    %eax,0x840
    base.s.size = 0;
 757:	c7 05 44 08 00 00 00 	movl   $0x0,0x844
 75e:	00 00 00 
  }
 ...
 7b4:	a3 48 08 00 00       	mov    %eax,0x848
      return (void*)(p + 1);
 ...
 7bf:	eb 3b                	jmp    7fc <malloc+0xe1>
    ...
    if(p == freep)
 7c1:	a1 48 08 00 00       	mov    0x848,%eax
