...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ed:	0f b6 91 34 08 00 00 	movzbl 0x834(%ecx),%edx
...
free(void *ap)
{
 ...
 5f0:	a1 50 08 00 00       	mov    0x850,%eax
 ...
 6bb:	a3 50 08 00 00       	mov    %eax,0x850
}
 6c0:	90                   	nop
 6c1:	c9                   	leave
 6c2:	c3                   	ret
...
morecore(uint nu)
{
 ...
 719:	83 c4 10             	add    $0x10,%esp
  return freep;
 71c:	a1 50 08 00 00       	mov    0x850,%eax
}
 721:	c9                   	leave
 722:	c3                   	ret
...
malloc(uint nbytes)
{
 ...
 735:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 738:	a1 50 08 00 00       	mov    0x850,%eax
 73d:	89 45 f0             	mov    %eax,-0x10(%ebp)
 740:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 744:	75 23                	jne    769 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 746:	c7 45 f0 48 08 00 00 	movl   $0x848,-0x10(%ebp)
 74d:	8b 45 f0             	mov    -0x10(%ebp),%eax
 750:	a3 50 08 00 00       	mov    %eax,0x850
 755:	a1 50 08 00 00       	mov    0x850,%eax
 75a:	a3 48 08 00 00       	mov    %eax,0x848
    base.s.size = 0;
 75f:	c7 05 4c 08 00 00 00 	movl   $0x0,0x84c
 766:	00 00 00 
  }
 ...
 7bc:	a3 50 08 00 00       	mov    %eax,0x850
      return (void*)(p + 1);
 ...
 7c7:	eb 3b                	jmp    804 <malloc+0xe1>
    ...
    if(p == freep)
 7c9:	a1 50 08 00 00       	mov    0x850,%eax
