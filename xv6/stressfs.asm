...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4c3:	0f b6 91 08 09 00 00 	movzbl 0x908(%ecx),%edx
...
free(void *ap)
{
 ...
 6c6:	a1 24 09 00 00       	mov    0x924,%eax
 ...
 791:	a3 24 09 00 00       	mov    %eax,0x924
}
 796:	90                   	nop
 797:	c9                   	leave
 798:	c3                   	ret
...
morecore(uint nu)
{
 ...
 7ef:	83 c4 10             	add    $0x10,%esp
  return freep;
 7f2:	a1 24 09 00 00       	mov    0x924,%eax
}
 7f7:	c9                   	leave
 7f8:	c3                   	ret
...
malloc(uint nbytes)
{
 ...
 80b:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 80e:	a1 24 09 00 00       	mov    0x924,%eax
 813:	89 45 f0             	mov    %eax,-0x10(%ebp)
 816:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 81a:	75 23                	jne    83f <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 81c:	c7 45 f0 1c 09 00 00 	movl   $0x91c,-0x10(%ebp)
 823:	8b 45 f0             	mov    -0x10(%ebp),%eax
 826:	a3 24 09 00 00       	mov    %eax,0x924
 82b:	a1 24 09 00 00       	mov    0x924,%eax
 830:	a3 1c 09 00 00       	mov    %eax,0x91c
    base.s.size = 0;
 835:	c7 05 20 09 00 00 00 	movl   $0x0,0x920
 83c:	00 00 00 
  }
 ...
 892:	a3 24 09 00 00       	mov    %eax,0x924
      return (void*)(p + 1);
 ...
 89d:	eb 3b                	jmp    8da <malloc+0xe1>
    ...
    if(p == freep)
 89f:	a1 24 09 00 00       	mov    0x924,%eax
