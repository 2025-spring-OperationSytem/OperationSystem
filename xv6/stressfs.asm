...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4cb:	0f b6 91 10 09 00 00 	movzbl 0x910(%ecx),%edx
...
free(void *ap)
{
 ...
 6ce:	a1 2c 09 00 00       	mov    0x92c,%eax
 ...
 799:	a3 2c 09 00 00       	mov    %eax,0x92c
}
 79e:	90                   	nop
 79f:	c9                   	leave
 7a0:	c3                   	ret
...
morecore(uint nu)
{
 ...
 7f7:	83 c4 10             	add    $0x10,%esp
  return freep;
 7fa:	a1 2c 09 00 00       	mov    0x92c,%eax
}
 7ff:	c9                   	leave
 800:	c3                   	ret
...
malloc(uint nbytes)
{
 ...
 813:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 816:	a1 2c 09 00 00       	mov    0x92c,%eax
 81b:	89 45 f0             	mov    %eax,-0x10(%ebp)
 81e:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 822:	75 23                	jne    847 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 824:	c7 45 f0 24 09 00 00 	movl   $0x924,-0x10(%ebp)
 82b:	8b 45 f0             	mov    -0x10(%ebp),%eax
 82e:	a3 2c 09 00 00       	mov    %eax,0x92c
 833:	a1 2c 09 00 00       	mov    0x92c,%eax
 838:	a3 24 09 00 00       	mov    %eax,0x924
    base.s.size = 0;
 83d:	c7 05 28 09 00 00 00 	movl   $0x0,0x928
 844:	00 00 00 
  }
 ...
 89a:	a3 2c 09 00 00       	mov    %eax,0x92c
      return (void*)(p + 1);
 ...
 8a5:	eb 3b                	jmp    8e2 <malloc+0xe1>
    ...
    if(p == freep)
 8a7:	a1 2c 09 00 00       	mov    0x92c,%eax
