...
main(void)
{
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     339:	b8 43 15 00 00       	mov    $0x1543,%eax
    ...
    if(fork1() == 0)
     ...
     35f:	68 40 15 00 00       	push   $0x1540
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     383:	6a 64                	push   $0x64
     385:	68 40 15 00 00       	push   $0x1540
...
gettoken(char **ps, char *es, char **q, char **eq)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     578:	50                   	push   %eax
     579:	68 10 15 00 00       	push   $0x1510
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     620:	50                   	push   %eax
     621:	68 10 15 00 00       	push   $0x1510
     ...
     63e:	50                   	push   %eax
     63f:	68 18 15 00 00       	push   $0x1518
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     681:	50                   	push   %eax
     682:	68 10 15 00 00       	push   $0x1510
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     6c8:	50                   	push   %eax
     6c9:	68 10 15 00 00       	push   $0x1510
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     ffd:	0f b6 91 20 15 00 00 	movzbl 0x1520(%ecx),%edx
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1200:	a1 ac 15 00 00       	mov    0x15ac,%eax
  ...
  freep = p;
    ...
    12cb:	a3 ac 15 00 00       	mov    %eax,0x15ac
}
    12d0:	90                   	nop
    12d1:	c9                   	leave
    12d2:	c3                   	ret
...
morecore(uint nu)
{
  ...
  return freep;
    132c:	a1 ac 15 00 00       	mov    0x15ac,%eax
}
    1331:	c9                   	leave
    1332:	c3                   	ret
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    1348:	a1 ac 15 00 00       	mov    0x15ac,%eax
    134d:	89 45 f0             	mov    %eax,-0x10(%ebp)
    1350:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    1354:	75 23                	jne    1379 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    1356:	c7 45 f0 a4 15 00 00 	movl   $0x15a4,-0x10(%ebp)
    135d:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1360:	a3 ac 15 00 00       	mov    %eax,0x15ac
    1365:	a1 ac 15 00 00       	mov    0x15ac,%eax
    136a:	a3 a4 15 00 00       	mov    %eax,0x15a4
    base.s.size = 0;
    136f:	c7 05 a8 15 00 00 00 	movl   $0x0,0x15a8
    1376:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    13cc:	a3 ac 15 00 00       	mov    %eax,0x15ac
      return (void*)(p + 1);
    ...
    if(p == freep)
    13d9:	a1 ac 15 00 00       	mov    0x15ac,%eax
