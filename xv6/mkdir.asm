...
printint(int fd, int xx, int base, int sgn)
{
 ...
 409:	0f b6 91 5c 08 00 00 	movzbl 0x85c(%ecx),%edx
...
free(void *ap)
{
 ...
 60c:	a1 78 08 00 00       	mov    0x878,%eax
 ...
 6d7:	a3 78 08 00 00       	mov    %eax,0x878
}
 6dc:	90                   	nop
 6dd:	c9                   	leave
 6de:	c3                   	ret
...
morecore(uint nu)
{
 ...
 735:	83 c4 10             	add    $0x10,%esp
  return freep;
 738:	a1 78 08 00 00       	mov    0x878,%eax
}
 73d:	c9                   	leave
 73e:	c3                   	ret
...
malloc(uint nbytes)
{
 ...
 751:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 754:	a1 78 08 00 00       	mov    0x878,%eax
 759:	89 45 f0             	mov    %eax,-0x10(%ebp)
 75c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 760:	75 23                	jne    785 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 762:	c7 45 f0 70 08 00 00 	movl   $0x870,-0x10(%ebp)
 769:	8b 45 f0             	mov    -0x10(%ebp),%eax
 76c:	a3 78 08 00 00       	mov    %eax,0x878
 771:	a1 78 08 00 00       	mov    0x878,%eax
 776:	a3 70 08 00 00       	mov    %eax,0x870
    base.s.size = 0;
 77b:	c7 05 74 08 00 00 00 	movl   $0x0,0x874
 782:	00 00 00 
  }
 ...
 7d8:	a3 78 08 00 00       	mov    %eax,0x878
      return (void*)(p + 1);
 ...
 7e3:	eb 3b                	jmp    820 <malloc+0xe1>
    ...
    if(p == freep)
 7e5:	a1 78 08 00 00       	mov    0x878,%eax
