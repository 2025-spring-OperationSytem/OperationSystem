...
grep(char *pattern, int fd)
{
  ...
  39:	ff 75 f0             	push   -0x10(%ebp)
  3c:	ff 75 08             	push   0x8(%ebp)
  ...
  b1:	ff 75 f4             	push   -0xc(%ebp)
  b4:	ff 75 f0             	push   -0x10(%ebp)
