...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3e3:	0f b6 91 18 08 00 00 	movzbl 0x818(%ecx),%edx
...
free(void *ap)
{
 ...
 5e6:	a1 34 08 00 00       	mov    0x834,%eax
 ...
 6b1:	a3 34 08 00 00       	mov    %eax,0x834
}
 6b6:	90                   	nop
 6b7:	c9                   	leave
 6b8:	c3                   	ret
...
morecore(uint nu)
{
 ...
 70f:	83 c4 10             	add    $0x10,%esp
  return freep;
 712:	a1 34 08 00 00       	mov    0x834,%eax
}
 717:	c9                   	leave
 718:	c3                   	ret
...
malloc(uint nbytes)
{
 ...
 72b:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 72e:	a1 34 08 00 00       	mov    0x834,%eax
 733:	89 45 f0             	mov    %eax,-0x10(%ebp)
 736:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 73a:	75 23                	jne    75f <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 73c:	c7 45 f0 2c 08 00 00 	movl   $0x82c,-0x10(%ebp)
 743:	8b 45 f0             	mov    -0x10(%ebp),%eax
 746:	a3 34 08 00 00       	mov    %eax,0x834
 74b:	a1 34 08 00 00       	mov    0x834,%eax
 750:	a3 2c 08 00 00       	mov    %eax,0x82c
    base.s.size = 0;
 755:	c7 05 30 08 00 00 00 	movl   $0x0,0x830
 75c:	00 00 00 
  }
 ...
 7b2:	a3 34 08 00 00       	mov    %eax,0x834
      return (void*)(p + 1);
 ...
 7bd:	eb 3b                	jmp    7fa <malloc+0xe1>
    ...
    if(p == freep)
 7bf:	a1 34 08 00 00       	mov    0x834,%eax
