...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3eb:	0f b6 91 20 08 00 00 	movzbl 0x820(%ecx),%edx
...
free(void *ap)
{
 ...
 5ee:	a1 3c 08 00 00       	mov    0x83c,%eax
 ...
 6b9:	a3 3c 08 00 00       	mov    %eax,0x83c
}
 6be:	90                   	nop
 6bf:	c9                   	leave
 6c0:	c3                   	ret
...
morecore(uint nu)
{
 ...
 717:	83 c4 10             	add    $0x10,%esp
  return freep;
 71a:	a1 3c 08 00 00       	mov    0x83c,%eax
}
 71f:	c9                   	leave
 720:	c3                   	ret
...
malloc(uint nbytes)
{
 ...
 733:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 736:	a1 3c 08 00 00       	mov    0x83c,%eax
 73b:	89 45 f0             	mov    %eax,-0x10(%ebp)
 73e:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 742:	75 23                	jne    767 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 744:	c7 45 f0 34 08 00 00 	movl   $0x834,-0x10(%ebp)
 74b:	8b 45 f0             	mov    -0x10(%ebp),%eax
 74e:	a3 3c 08 00 00       	mov    %eax,0x83c
 753:	a1 3c 08 00 00       	mov    0x83c,%eax
 758:	a3 34 08 00 00       	mov    %eax,0x834
    base.s.size = 0;
 75d:	c7 05 38 08 00 00 00 	movl   $0x0,0x838
 764:	00 00 00 
  }
 ...
 7ba:	a3 3c 08 00 00       	mov    %eax,0x83c
      return (void*)(p + 1);
 ...
 7c5:	eb 3b                	jmp    802 <malloc+0xe1>
    ...
    if(p == freep)
 7c7:	a1 3c 08 00 00       	mov    0x83c,%eax
