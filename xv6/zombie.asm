...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3a5:	0f b6 91 c8 07 00 00 	movzbl 0x7c8(%ecx),%edx
...
free(void *ap)
{
 ...
 5a8:	a1 e4 07 00 00       	mov    0x7e4,%eax
 ...
 673:	a3 e4 07 00 00       	mov    %eax,0x7e4
}
 678:	90                   	nop
 679:	c9                   	leave
 67a:	c3                   	ret
...
morecore(uint nu)
{
 ...
 6d1:	83 c4 10             	add    $0x10,%esp
  return freep;
 6d4:	a1 e4 07 00 00       	mov    0x7e4,%eax
}
 6d9:	c9                   	leave
 6da:	c3                   	ret
...
malloc(uint nbytes)
{
 ...
 6ed:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 6f0:	a1 e4 07 00 00       	mov    0x7e4,%eax
 6f5:	89 45 f0             	mov    %eax,-0x10(%ebp)
 6f8:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 6fc:	75 23                	jne    721 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 6fe:	c7 45 f0 dc 07 00 00 	movl   $0x7dc,-0x10(%ebp)
 705:	8b 45 f0             	mov    -0x10(%ebp),%eax
 708:	a3 e4 07 00 00       	mov    %eax,0x7e4
 70d:	a1 e4 07 00 00       	mov    0x7e4,%eax
 712:	a3 dc 07 00 00       	mov    %eax,0x7dc
    base.s.size = 0;
 717:	c7 05 e0 07 00 00 00 	movl   $0x0,0x7e0
 71e:	00 00 00 
  }
 ...
 774:	a3 e4 07 00 00       	mov    %eax,0x7e4
      return (void*)(p + 1);
 ...
 77f:	eb 3b                	jmp    7bc <malloc+0xe1>
    ...
    if(p == freep)
 781:	a1 e4 07 00 00       	mov    0x7e4,%eax
