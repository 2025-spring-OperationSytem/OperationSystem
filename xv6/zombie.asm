...
printint(int fd, int xx, int base, int sgn)
{
 ...
 39d:	0f b6 91 c0 07 00 00 	movzbl 0x7c0(%ecx),%edx
...
free(void *ap)
{
 ...
 5a0:	a1 dc 07 00 00       	mov    0x7dc,%eax
 ...
 66b:	a3 dc 07 00 00       	mov    %eax,0x7dc
}
 670:	90                   	nop
 671:	c9                   	leave
 672:	c3                   	ret
...
morecore(uint nu)
{
 ...
 6c9:	83 c4 10             	add    $0x10,%esp
  return freep;
 6cc:	a1 dc 07 00 00       	mov    0x7dc,%eax
}
 6d1:	c9                   	leave
 6d2:	c3                   	ret
...
malloc(uint nbytes)
{
 ...
 6e5:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 6e8:	a1 dc 07 00 00       	mov    0x7dc,%eax
 6ed:	89 45 f0             	mov    %eax,-0x10(%ebp)
 6f0:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 6f4:	75 23                	jne    719 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 6f6:	c7 45 f0 d4 07 00 00 	movl   $0x7d4,-0x10(%ebp)
 6fd:	8b 45 f0             	mov    -0x10(%ebp),%eax
 700:	a3 dc 07 00 00       	mov    %eax,0x7dc
 705:	a1 dc 07 00 00       	mov    0x7dc,%eax
 70a:	a3 d4 07 00 00       	mov    %eax,0x7d4
    base.s.size = 0;
 70f:	c7 05 d8 07 00 00 00 	movl   $0x0,0x7d8
 716:	00 00 00 
  }
 ...
 76c:	a3 dc 07 00 00       	mov    %eax,0x7dc
      return (void*)(p + 1);
 ...
 777:	eb 3b                	jmp    7b4 <malloc+0xe1>
    ...
    if(p == freep)
 779:	a1 dc 07 00 00       	mov    0x7dc,%eax
