...
printint(int fd, int xx, int base, int sgn)
{
 ...
 395:	0f b6 91 b8 07 00 00 	movzbl 0x7b8(%ecx),%edx
...
free(void *ap)
{
 ...
 598:	a1 d4 07 00 00       	mov    0x7d4,%eax
 ...
 663:	a3 d4 07 00 00       	mov    %eax,0x7d4
}
 668:	90                   	nop
 669:	c9                   	leave
 66a:	c3                   	ret
...
morecore(uint nu)
{
 ...
 6c1:	83 c4 10             	add    $0x10,%esp
  return freep;
 6c4:	a1 d4 07 00 00       	mov    0x7d4,%eax
}
 6c9:	c9                   	leave
 6ca:	c3                   	ret
...
malloc(uint nbytes)
{
 ...
 6dd:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 6e0:	a1 d4 07 00 00       	mov    0x7d4,%eax
 6e5:	89 45 f0             	mov    %eax,-0x10(%ebp)
 6e8:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 6ec:	75 23                	jne    711 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 6ee:	c7 45 f0 cc 07 00 00 	movl   $0x7cc,-0x10(%ebp)
 6f5:	8b 45 f0             	mov    -0x10(%ebp),%eax
 6f8:	a3 d4 07 00 00       	mov    %eax,0x7d4
 6fd:	a1 d4 07 00 00       	mov    0x7d4,%eax
 702:	a3 cc 07 00 00       	mov    %eax,0x7cc
    base.s.size = 0;
 707:	c7 05 d0 07 00 00 00 	movl   $0x0,0x7d0
 70e:	00 00 00 
  }
 ...
 764:	a3 d4 07 00 00       	mov    %eax,0x7d4
      return (void*)(p + 1);
 ...
 76f:	eb 3b                	jmp    7ac <malloc+0xe1>
    ...
    if(p == freep)
 771:	a1 d4 07 00 00       	mov    0x7d4,%eax
