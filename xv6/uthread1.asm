...
thread_init(void)
{
  ...
  current_thread = &all_thread[0];
   6:	c7 05 c0 0a 00 00 e0 	movl   $0xae0,0xac0
   d:	0a 00 00 
  current_thread->state = RUNNING;
  10:	a1 c0 0a 00 00       	mov    0xac0,%eax
...
{ 
  ...
  next_thread = 0;
  39:	c7 05 c4 0a 00 00 00 	movl   $0x0,0xac4
  40:	00 00 00 
  for (t = all_thread; t < all_thread + MAX_THREAD; t++) {
  43:	c7 45 f4 e0 0a 00 00 	movl   $0xae0,-0xc(%ebp)
  4a:	eb 41                	jmp    8d <thread_schedule+0x5a>
    //printf(1,"t: %x, state %x \n", t, t->state);
    if(t == &all_thread[0] && t->state == RUNNABLE){
  4c:	81 7d f4 e0 0a 00 00 	cmpl   $0xae0,-0xc(%ebp)
  ...
  8d:	b8 30 4b 01 00       	mov    $0x14b30,%eax
 ...
 11c:	eb 0a                	jmp    128 <thread_schedule+0xf5>
    next_thread = 0;
 11e:	c7 05 c4 0a 00 00 00 	movl   $0x0,0xac4
 125:	00 00 00 
}
 128:	90                   	nop
 129:	c9                   	leave
...
thread_create(void (*func)())
{
 ...
 134:	68 46 0a 00 00       	push   $0xa46
 139:	6a 01                	push   $0x1
 13b:	e8 27 05 00 00       	call   667 <printf>
 140:	83 c4 10             	add    $0x10,%esp
  thread_p t;

  for (t = all_thread; t < all_thread + MAX_THREAD; t++) {
 143:	c7 45 f4 e0 0a 00 00 	movl   $0xae0,-0xc(%ebp)
 ...
 160:	b8 30 4b 01 00       	mov    $0x14b30,%eax
...
mythread(void)
{
 ...
 1be:	68 55 0a 00 00       	push   $0xa55
 1c3:	6a 01                	push   $0x1
 1c5:	e8 9d 04 00 00       	call   667 <printf>
 1ca:	83 c4 10             	add    $0x10,%esp
  for (i = 0; i < 10; i++) {
 1cd:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
 1d4:	eb 1c                	jmp    1f2 <mythread+0x3d>
    printf(1, "my thread 0x%x\n", (int) current_thread);
 1d6:	a1 c0 0a 00 00       	mov    0xac0,%eax
 1db:	83 ec 04             	sub    $0x4,%esp
 1de:	50                   	push   %eax
 1df:	68 68 0a 00 00       	push   $0xa68
 1e4:	6a 01                	push   $0x1
 1e6:	e8 7c 04 00 00       	call   667 <printf>
 ...
 1fb:	68 78 0a 00 00       	push   $0xa78
 200:	6a 01                	push   $0x1
 202:	e8 60 04 00 00       	call   667 <printf>
 207:	83 c4 10             	add    $0x10,%esp
  current_thread->state = FREE;
 20a:	a1 c0 0a 00 00       	mov    0xac0,%eax
...
thread_switch:
 ...
 26d:	a1 c0 0a 00 00       	mov    0xac0,%eax
    movl %esp, (%eax)
 272:	89 20                	mov    %esp,(%eax)

    movl next_thread, %eax
 274:	a1 c4 0a 00 00       	mov    0xac4,%eax
    movl (%eax), %esp
 279:	8b 20                	mov    (%eax),%esp
    # esp = t1.주소

    movl %eax, current_thread
 27b:	a3 c0 0a 00 00       	mov    %eax,0xac0
 ...
 280:	61                   	popa
    ...
    movl $0, next_thread
 281:	c7 05 c4 0a 00 00 00 	movl   $0x0,0xac4
 288:	00 00 00 
...
putc(int fd, char c)
{
 ...
 5ab:	e8 53 ff ff ff       	call   503 <write>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 5c7:	74 17                	je     5e0 <printint+0x2a>
 5c9:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
 5cd:	79 11                	jns    5e0 <printint+0x2a>
    neg = 1;
 ...
 5de:	eb 06                	jmp    5e6 <printint+0x30>
  } else {
    x = xx;
 ...
 605:	0f b6 91 90 0a 00 00 	movzbl 0xa90(%ecx),%edx
 60c:	88 54 05 dc          	mov    %dl,-0x24(%ebp,%eax,1)
  }while((x /= base) != 0);
 ...
 624:	75 c7                	jne    5ed <printint+0x37>
  if(neg)
 626:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 62a:	74 2d                	je     659 <printint+0xa3>
    buf[i++] = '-';
 ...
 635:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)
  ...
  while(--i >= 0)
 63a:	eb 1d                	jmp    659 <printint+0xa3>
    putc(fd, buf[i]);
...
printf(int fd, char *fmt, ...)
{
 ...
 66d:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  ap = (uint*)(void*)&fmt + 1;
 674:	8d 45 0c             	lea    0xc(%ebp),%eax
 677:	83 c0 04             	add    $0x4,%eax
 67a:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
 67d:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
 684:	e9 59 01 00 00       	jmp    7e2 <printf+0x17b>
    c = fmt[i] & 0xff;
 ...
 697:	25 ff 00 00 00       	and    $0xff,%eax
 69c:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
 69f:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
 6a3:	75 2c                	jne    6d1 <printf+0x6a>
      if(c == '%'){
 6a5:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
 6a9:	75 0c                	jne    6b7 <printf+0x50>
        state = '%';
 6ab:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
 6b2:	e9 27 01 00 00       	jmp    7de <printf+0x177>
      } else {
        putc(fd, c);
 ...
 6c4:	e8 ca fe ff ff       	call   593 <putc>
 6c9:	83 c4 10             	add    $0x10,%esp
 6cc:	e9 0d 01 00 00       	jmp    7de <printf+0x177>
      }
    } else if(state == '%'){
 6d1:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
 6d5:	0f 85 03 01 00 00    	jne    7de <printf+0x177>
      if(c == 'd'){
 6db:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
 6df:	75 1e                	jne    6ff <printf+0x98>
        printint(fd, *ap, 10, 1);
 ...
 6ee:	e8 c3 fe ff ff       	call   5b6 <printint>
 6f3:	83 c4 10             	add    $0x10,%esp
        ap++;
 6f6:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
 6fa:	e9 d8 00 00 00       	jmp    7d7 <printf+0x170>
      } else if(c == 'x' || c == 'p'){
 6ff:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
 703:	74 06                	je     70b <printf+0xa4>
 705:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
 709:	75 1e                	jne    729 <printf+0xc2>
        printint(fd, *ap, 16, 0);
 ...
 718:	e8 99 fe ff ff       	call   5b6 <printint>
 71d:	83 c4 10             	add    $0x10,%esp
        ap++;
 720:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
 724:	e9 ae 00 00 00       	jmp    7d7 <printf+0x170>
      } else if(c == 's'){
 729:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
 72d:	75 43                	jne    772 <printf+0x10b>
        s = (char*)*ap;
 ...
 73f:	75 25                	jne    766 <printf+0xff>
          s = "(null)";
 741:	c7 45 f4 89 0a 00 00 	movl   $0xa89,-0xc(%ebp)
        while(*s != 0){
 748:	eb 1c                	jmp    766 <printf+0xff>
          putc(fd, *s);
 ...
 75a:	e8 34 fe ff ff       	call   593 <putc>
 ...
 76e:	75 da                	jne    74a <printf+0xe3>
 770:	eb 65                	jmp    7d7 <printf+0x170>
        }
      } else if(c == 'c'){
 772:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
 776:	75 1d                	jne    795 <printf+0x12e>
        putc(fd, *ap);
 ...
 793:	eb 42                	jmp    7d7 <printf+0x170>
      } else if(c == '%'){
 795:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
 799:	75 17                	jne    7b2 <printf+0x14b>
        putc(fd, c);
 ...
 7a8:	e8 e6 fd ff ff       	call   593 <putc>
 7ad:	83 c4 10             	add    $0x10,%esp
 7b0:	eb 25                	jmp    7d7 <printf+0x170>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
 7b2:	83 ec 08             	sub    $0x8,%esp
 7b5:	6a 25                	push   $0x25
 7b7:	ff 75 08             	push   0x8(%ebp)
 7ba:	e8 d4 fd ff ff       	call   593 <putc>
 ...
 7cf:	e8 bf fd ff ff       	call   593 <putc>
 ...
 7ef:	0f 85 94 fe ff ff    	jne    689 <printf+0x22>
    }
  }
}
 7f5:	90                   	nop
...
free(void *ap)
{
 ...
 808:	a1 38 4b 01 00       	mov    0x14b38,%eax
 ...
 81a:	72 12                	jb     82e <free+0x35>
 81c:	8b 45 f8             	mov    -0x8(%ebp),%eax
 81f:	39 45 fc             	cmp    %eax,-0x4(%ebp)
 822:	72 24                	jb     848 <free+0x4f>
 824:	8b 45 fc             	mov    -0x4(%ebp),%eax
 827:	8b 00                	mov    (%eax),%eax
 829:	39 45 f8             	cmp    %eax,-0x8(%ebp)
 82c:	72 1a                	jb     848 <free+0x4f>
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
 ...
 8d3:	a3 38 4b 01 00       	mov    %eax,0x14b38
}
 8d8:	90                   	nop
 8d9:	c9                   	leave
 8da:	c3                   	ret
...
morecore(uint nu)
{
 ...
 8de:	83 ec 18             	sub    $0x18,%esp
  ...
  if(nu < 4096)
 8e1:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
 8e8:	77 07                	ja     8f1 <morecore+0x16>
    nu = 4096;
 8ea:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
 8f1:	8b 45 08             	mov    0x8(%ebp),%eax
 8f4:	c1 e0 03             	shl    $0x3,%eax
 8f7:	83 ec 0c             	sub    $0xc,%esp
 8fa:	50                   	push   %eax
 8fb:	e8 6b fc ff ff       	call   56b <sbrk>
 900:	83 c4 10             	add    $0x10,%esp
 903:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
 906:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
 90a:	75 07                	jne    913 <morecore+0x38>
    return 0;
 90c:	b8 00 00 00 00       	mov    $0x0,%eax
 911:	eb 26                	jmp    939 <morecore+0x5e>
  hp = (Header*)p;
 ...
 92b:	50                   	push   %eax
 92c:	e8 c8 fe ff ff       	call   7f9 <free>
 931:	83 c4 10             	add    $0x10,%esp
  return freep;
 934:	a1 38 4b 01 00       	mov    0x14b38,%eax
}
 939:	c9                   	leave
 93a:	c3                   	ret
...
malloc(uint nbytes)
{
 ...
 94d:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 950:	a1 38 4b 01 00       	mov    0x14b38,%eax
 955:	89 45 f0             	mov    %eax,-0x10(%ebp)
 958:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 95c:	75 23                	jne    981 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 95e:	c7 45 f0 30 4b 01 00 	movl   $0x14b30,-0x10(%ebp)
 965:	8b 45 f0             	mov    -0x10(%ebp),%eax
 968:	a3 38 4b 01 00       	mov    %eax,0x14b38
 96d:	a1 38 4b 01 00       	mov    0x14b38,%eax
 972:	a3 30 4b 01 00       	mov    %eax,0x14b30
    base.s.size = 0;
 977:	c7 05 34 4b 01 00 00 	movl   $0x0,0x14b34
 97e:	00 00 00 
  }
 ...
 9d4:	a3 38 4b 01 00       	mov    %eax,0x14b38
      return (void*)(p + 1);
 9d9:	8b 45 f4             	mov    -0xc(%ebp),%eax
 9dc:	83 c0 08             	add    $0x8,%eax
 9df:	eb 3b                	jmp    a1c <malloc+0xe1>
    }
    if(p == freep)
 9e1:	a1 38 4b 01 00       	mov    0x14b38,%eax
 9e6:	39 45 f4             	cmp    %eax,-0xc(%ebp)
 9e9:	75 1e                	jne    a09 <malloc+0xce>
      if((p = morecore(nunits)) == 0)
 9eb:	83 ec 0c             	sub    $0xc,%esp
 9ee:	ff 75 ec             	push   -0x14(%ebp)
 9f1:	e8 e5 fe ff ff       	call   8db <morecore>
 9f6:	83 c4 10             	add    $0x10,%esp
 9f9:	89 45 f4             	mov    %eax,-0xc(%ebp)
 9fc:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 a00:	75 07                	jne    a09 <malloc+0xce>
        return 0;
 a02:	b8 00 00 00 00       	mov    $0x0,%eax
 a07:	eb 13                	jmp    a1c <malloc+0xe1>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 ...
 a14:	89 45 f4             	mov    %eax,-0xc(%ebp)
    if(p->s.size >= nunits){
 a17:	e9 6d ff ff ff       	jmp    989 <malloc+0x4e>
  }
}
 a1c:	c9                   	leave
 a1d:	c3                   	ret
