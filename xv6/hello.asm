...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ab:	0f b6 91 f4 07 00 00 	movzbl 0x7f4(%ecx),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 4e5:	75 25                	jne    50c <printf+0xff>
          s = "(null)";
 4e7:	c7 45 f4 ed 07 00 00 	movl   $0x7ed,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 5ae:	a1 10 08 00 00       	mov    0x810,%eax
 ...
 679:	a3 10 08 00 00       	mov    %eax,0x810
}
 67e:	90                   	nop
 67f:	c9                   	leave
 680:	c3                   	ret
...
morecore(uint nu)
{
 ...
 6d7:	83 c4 10             	add    $0x10,%esp
  return freep;
 6da:	a1 10 08 00 00       	mov    0x810,%eax
}
 6df:	c9                   	leave
 6e0:	c3                   	ret
...
malloc(uint nbytes)
{
 ...
 6f3:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 6f6:	a1 10 08 00 00       	mov    0x810,%eax
 6fb:	89 45 f0             	mov    %eax,-0x10(%ebp)
 6fe:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 702:	75 23                	jne    727 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 704:	c7 45 f0 08 08 00 00 	movl   $0x808,-0x10(%ebp)
 70b:	8b 45 f0             	mov    -0x10(%ebp),%eax
 70e:	a3 10 08 00 00       	mov    %eax,0x810
 713:	a1 10 08 00 00       	mov    0x810,%eax
 718:	a3 08 08 00 00       	mov    %eax,0x808
    base.s.size = 0;
 71d:	c7 05 0c 08 00 00 00 	movl   $0x0,0x80c
 724:	00 00 00 
  }
 ...
 77a:	a3 10 08 00 00       	mov    %eax,0x810
      return (void*)(p + 1);
 ...
 785:	eb 3b                	jmp    7c2 <malloc+0xe1>
    ...
    if(p == freep)
 787:	a1 10 08 00 00       	mov    0x810,%eax
