...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4a4:	0f b6 91 fc 08 00 00 	movzbl 0x8fc(%ecx),%edx
...
free(void *ap)
{
 ...
 6a7:	a1 28 0b 00 00       	mov    0xb28,%eax
 ...
 772:	a3 28 0b 00 00       	mov    %eax,0xb28
}
 777:	90                   	nop
 778:	c9                   	leave
 779:	c3                   	ret
...
morecore(uint nu)
{
 ...
 7d0:	83 c4 10             	add    $0x10,%esp
  return freep;
 7d3:	a1 28 0b 00 00       	mov    0xb28,%eax
}
 7d8:	c9                   	leave
 7d9:	c3                   	ret
...
malloc(uint nbytes)
{
 ...
 7ec:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 7ef:	a1 28 0b 00 00       	mov    0xb28,%eax
 7f4:	89 45 f0             	mov    %eax,-0x10(%ebp)
 7f7:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 7fb:	75 23                	jne    820 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 7fd:	c7 45 f0 20 0b 00 00 	movl   $0xb20,-0x10(%ebp)
 804:	8b 45 f0             	mov    -0x10(%ebp),%eax
 807:	a3 28 0b 00 00       	mov    %eax,0xb28
 80c:	a1 28 0b 00 00       	mov    0xb28,%eax
 811:	a3 20 0b 00 00       	mov    %eax,0xb20
    base.s.size = 0;
 816:	c7 05 24 0b 00 00 00 	movl   $0x0,0xb24
 81d:	00 00 00 
  }
 ...
 873:	a3 28 0b 00 00       	mov    %eax,0xb28
      return (void*)(p + 1);
 ...
 87e:	eb 3b                	jmp    8bb <malloc+0xe1>
    ...
    if(p == freep)
 880:	a1 28 0b 00 00       	mov    0xb28,%eax
