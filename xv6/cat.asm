...
printint(int fd, int xx, int base, int sgn)
{
 ...
 49c:	0f b6 91 f4 08 00 00 	movzbl 0x8f4(%ecx),%edx
...
free(void *ap)
{
 ...
 69f:	a1 28 0b 00 00       	mov    0xb28,%eax
 ...
 76a:	a3 28 0b 00 00       	mov    %eax,0xb28
}
 76f:	90                   	nop
 770:	c9                   	leave
 771:	c3                   	ret
...
morecore(uint nu)
{
 ...
 7c8:	83 c4 10             	add    $0x10,%esp
  return freep;
 7cb:	a1 28 0b 00 00       	mov    0xb28,%eax
}
 7d0:	c9                   	leave
 7d1:	c3                   	ret
...
malloc(uint nbytes)
{
 ...
 7e4:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 7e7:	a1 28 0b 00 00       	mov    0xb28,%eax
 7ec:	89 45 f0             	mov    %eax,-0x10(%ebp)
 7ef:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 7f3:	75 23                	jne    818 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 7f5:	c7 45 f0 20 0b 00 00 	movl   $0xb20,-0x10(%ebp)
 7fc:	8b 45 f0             	mov    -0x10(%ebp),%eax
 7ff:	a3 28 0b 00 00       	mov    %eax,0xb28
 804:	a1 28 0b 00 00       	mov    0xb28,%eax
 809:	a3 20 0b 00 00       	mov    %eax,0xb20
    base.s.size = 0;
 80e:	c7 05 24 0b 00 00 00 	movl   $0x0,0xb24
 815:	00 00 00 
  }
 ...
 86b:	a3 28 0b 00 00       	mov    %eax,0xb28
      return (void*)(p + 1);
 ...
 876:	eb 3b                	jmp    8b3 <malloc+0xe1>
    ...
    if(p == freep)
 878:	a1 28 0b 00 00       	mov    0xb28,%eax
