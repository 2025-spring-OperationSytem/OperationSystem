...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3f9:	0f b6 91 48 08 00 00 	movzbl 0x848(%ecx),%edx
...
free(void *ap)
{
 ...
 5fc:	a1 64 08 00 00       	mov    0x864,%eax
 ...
 6c7:	a3 64 08 00 00       	mov    %eax,0x864
}
 6cc:	90                   	nop
 6cd:	c9                   	leave
 6ce:	c3                   	ret
...
morecore(uint nu)
{
 ...
 725:	83 c4 10             	add    $0x10,%esp
  return freep;
 728:	a1 64 08 00 00       	mov    0x864,%eax
}
 72d:	c9                   	leave
 72e:	c3                   	ret
...
malloc(uint nbytes)
{
 ...
 752:	c7 45 f0 5c 08 00 00 	movl   $0x85c,-0x10(%ebp)
 759:	8b 45 f0             	mov    -0x10(%ebp),%eax
 75c:	a3 64 08 00 00       	mov    %eax,0x864
 761:	a1 64 08 00 00       	mov    0x864,%eax
 766:	a3 5c 08 00 00       	mov    %eax,0x85c
    base.s.size = 0;
 76b:	c7 05 60 08 00 00 00 	movl   $0x0,0x860
 772:	00 00 00 
  }
 ...
 7c8:	a3 64 08 00 00       	mov    %eax,0x864
      return (void*)(p + 1);
 ...
 7d3:	eb 3b                	jmp    810 <malloc+0xe1>
    ...
    if(p == freep)
 7d5:	a1 64 08 00 00       	mov    0x864,%eax
