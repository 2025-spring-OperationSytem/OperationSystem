...
printint(int fd, int xx, int base, int sgn)
{
 ...
 401:	0f b6 91 50 08 00 00 	movzbl 0x850(%ecx),%edx
...
free(void *ap)
{
 ...
 604:	a1 6c 08 00 00       	mov    0x86c,%eax
 ...
 6cf:	a3 6c 08 00 00       	mov    %eax,0x86c
}
 6d4:	90                   	nop
 6d5:	c9                   	leave
 6d6:	c3                   	ret
...
morecore(uint nu)
{
 ...
 72d:	83 c4 10             	add    $0x10,%esp
  return freep;
 730:	a1 6c 08 00 00       	mov    0x86c,%eax
}
 735:	c9                   	leave
 736:	c3                   	ret
...
malloc(uint nbytes)
{
 ...
 749:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 74c:	a1 6c 08 00 00       	mov    0x86c,%eax
 751:	89 45 f0             	mov    %eax,-0x10(%ebp)
 754:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 758:	75 23                	jne    77d <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 75a:	c7 45 f0 64 08 00 00 	movl   $0x864,-0x10(%ebp)
 761:	8b 45 f0             	mov    -0x10(%ebp),%eax
 764:	a3 6c 08 00 00       	mov    %eax,0x86c
 769:	a1 6c 08 00 00       	mov    0x86c,%eax
 76e:	a3 64 08 00 00       	mov    %eax,0x864
    base.s.size = 0;
 773:	c7 05 68 08 00 00 00 	movl   $0x0,0x868
 77a:	00 00 00 
  }
 ...
 7d0:	a3 6c 08 00 00       	mov    %eax,0x86c
      return (void*)(p + 1);
 ...
 7db:	eb 3b                	jmp    818 <malloc+0xe1>
    ...
    if(p == freep)
 7dd:	a1 6c 08 00 00       	mov    0x86c,%eax
