...
_mlfq_test3:     file format elf32-i386
...
void run_policy_3() {
 ...
 26e:	0f 8e 58 ff ff ff    	jle    1cc <run_policy_3+0x35>
    }
  }

  printf(1, "[DEBUG] Setting sched_policy = 3 (no boosting)\n");
 274:	83 ec 08             	sub    $0x8,%esp
 277:	68 40 0c 00 00       	push   $0xc40
 27c:	6a 01                	push   $0x1
...
int main(void) {
 ...
 302:	68 94 0c 00 00       	push   $0xc94
 307:	6a 01                	push   $0x1
 309:	e8 43 04 00 00       	call   751 <printf>
 30e:	83 c4 10             	add    $0x10,%esp
  run_policy_3();
 311:	e8 81 fe ff ff       	call   197 <run_policy_3>
  printf(1, "\n===== [POLICY 3: exit] =====\n");
 316:	83 ec 08             	sub    $0x8,%esp
 319:	68 c4 0c 00 00       	push   $0xcc4
 31e:	6a 01                	push   $0x1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 6ef:	0f b6 91 a0 0f 00 00 	movzbl 0xfa0(%ecx),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 82d:	75 25                	jne    854 <printf+0x103>
          s = "(null)";
 82f:	c7 45 f4 e3 0c 00 00 	movl   $0xce3,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 8fa:	a1 bc 0f 00 00       	mov    0xfbc,%eax
 ...
 9c5:	a3 bc 0f 00 00       	mov    %eax,0xfbc
}
 9ca:	90                   	nop
 9cb:	c9                   	leave
 9cc:	c3                   	ret
...
morecore(uint nu)
{
 ...
 a27:	83 c4 10             	add    $0x10,%esp
  return freep;
 a2a:	a1 bc 0f 00 00       	mov    0xfbc,%eax
}
 a2f:	c9                   	leave
 a30:	c3                   	ret
...
malloc(uint nbytes)
{
 ...
 a47:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 a4a:	a1 bc 0f 00 00       	mov    0xfbc,%eax
 a4f:	89 45 f0             	mov    %eax,-0x10(%ebp)
 a52:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 a56:	75 23                	jne    a7b <malloc+0x4a>
    base.s.ptr = freep = prevp = &base;
 a58:	c7 45 f0 b4 0f 00 00 	movl   $0xfb4,-0x10(%ebp)
 a5f:	8b 45 f0             	mov    -0x10(%ebp),%eax
 a62:	a3 bc 0f 00 00       	mov    %eax,0xfbc
 a67:	a1 bc 0f 00 00       	mov    0xfbc,%eax
 a6c:	a3 b4 0f 00 00       	mov    %eax,0xfb4
    base.s.size = 0;
 a71:	c7 05 b8 0f 00 00 00 	movl   $0x0,0xfb8
 a78:	00 00 00 
  }
 ...
 ace:	a3 bc 0f 00 00       	mov    %eax,0xfbc
      return (void*)(p + 1);
 ...
 ad9:	eb 3b                	jmp    b16 <malloc+0xe5>
    ...
    if(p == freep)
 adb:	a1 bc 0f 00 00       	mov    0xfbc,%eax
