...
void run_policy_3() {
 ...
 265:	0f 8e 58 ff ff ff    	jle    1c3 <run_policy_3+0x31>
    }
  }

  printf(1, "[DEBUG] Setting sched_policy = 3 (no boosting)\n");
 26b:	83 ec 08             	sub    $0x8,%esp
 26e:	68 f8 0b 00 00       	push   $0xbf8
 273:	6a 01                	push   $0x1
...
int main(void) {
 ...
 2f5:	68 4c 0c 00 00       	push   $0xc4c
 2fa:	6a 01                	push   $0x1
 2fc:	e8 17 04 00 00       	call   718 <printf>
 301:	83 c4 10             	add    $0x10,%esp
  run_policy_3();
 304:	e8 89 fe ff ff       	call   192 <run_policy_3>
  printf(1, "\n===== [POLICY 3: exit] =====\n");
 309:	83 ec 08             	sub    $0x8,%esp
 30c:	68 7c 0c 00 00       	push   $0xc7c
 311:	6a 01                	push   $0x1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 6b6:	0f b6 91 58 0f 00 00 	movzbl 0xf58(%ecx),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 7f0:	75 25                	jne    817 <printf+0xff>
          s = "(null)";
 7f2:	c7 45 f4 9b 0c 00 00 	movl   $0xc9b,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 8b9:	a1 74 0f 00 00       	mov    0xf74,%eax
 ...
 984:	a3 74 0f 00 00       	mov    %eax,0xf74
}
 989:	90                   	nop
 98a:	c9                   	leave
 98b:	c3                   	ret
...
morecore(uint nu)
{
 ...
 9e2:	83 c4 10             	add    $0x10,%esp
  return freep;
 9e5:	a1 74 0f 00 00       	mov    0xf74,%eax
}
 9ea:	c9                   	leave
 9eb:	c3                   	ret
...
malloc(uint nbytes)
{
 ...
 9fe:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 a01:	a1 74 0f 00 00       	mov    0xf74,%eax
 a06:	89 45 f0             	mov    %eax,-0x10(%ebp)
 a09:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 a0d:	75 23                	jne    a32 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 a0f:	c7 45 f0 6c 0f 00 00 	movl   $0xf6c,-0x10(%ebp)
 a16:	8b 45 f0             	mov    -0x10(%ebp),%eax
 a19:	a3 74 0f 00 00       	mov    %eax,0xf74
 a1e:	a1 74 0f 00 00       	mov    0xf74,%eax
 a23:	a3 6c 0f 00 00       	mov    %eax,0xf6c
    base.s.size = 0;
 a28:	c7 05 70 0f 00 00 00 	movl   $0x0,0xf70
 a2f:	00 00 00 
  }
 ...
 a85:	a3 74 0f 00 00       	mov    %eax,0xf74
      return (void*)(p + 1);
 ...
 a90:	eb 3b                	jmp    acd <malloc+0xe1>
    ...
    if(p == freep)
 a92:	a1 74 0f 00 00       	mov    0xf74,%eax
