...
wc(int fd, char *name)
{
  ...
  d4:	ff 75 0c             	push   0xc(%ebp)
  d7:	ff 75 e8             	push   -0x18(%ebp)
  da:	ff 75 ec             	push   -0x14(%ebp)
  dd:	ff 75 f0             	push   -0x10(%ebp)
