...
printint(int fd, int xx, int base, int sgn)
{
 ...
 536:	0f b6 91 90 09 00 00 	movzbl 0x990(%ecx),%edx
...
free(void *ap)
{
 ...
 739:	a1 c8 0b 00 00       	mov    0xbc8,%eax
 ...
 804:	a3 c8 0b 00 00       	mov    %eax,0xbc8
}
 809:	90                   	nop
 80a:	c9                   	leave
 80b:	c3                   	ret
...
morecore(uint nu)
{
 ...
 862:	83 c4 10             	add    $0x10,%esp
  return freep;
 865:	a1 c8 0b 00 00       	mov    0xbc8,%eax
}
 86a:	c9                   	leave
 86b:	c3                   	ret
...
malloc(uint nbytes)
{
 ...
 88f:	c7 45 f0 c0 0b 00 00 	movl   $0xbc0,-0x10(%ebp)
 896:	8b 45 f0             	mov    -0x10(%ebp),%eax
 899:	a3 c8 0b 00 00       	mov    %eax,0xbc8
 89e:	a1 c8 0b 00 00       	mov    0xbc8,%eax
 8a3:	a3 c0 0b 00 00       	mov    %eax,0xbc0
    base.s.size = 0;
 8a8:	c7 05 c4 0b 00 00 00 	movl   $0x0,0xbc4
 8af:	00 00 00 
  }
 ...
 905:	a3 c8 0b 00 00       	mov    %eax,0xbc8
      return (void*)(p + 1);
 ...
 910:	eb 3b                	jmp    94d <malloc+0xe1>
    ...
    if(p == freep)
 912:	a1 c8 0b 00 00       	mov    0xbc8,%eax
