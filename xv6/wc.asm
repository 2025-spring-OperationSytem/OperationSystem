...
printint(int fd, int xx, int base, int sgn)
{
 ...
 52e:	0f b6 91 88 09 00 00 	movzbl 0x988(%ecx),%edx
...
free(void *ap)
{
 ...
 731:	a1 a8 0b 00 00       	mov    0xba8,%eax
 ...
 7fc:	a3 a8 0b 00 00       	mov    %eax,0xba8
}
 801:	90                   	nop
 802:	c9                   	leave
 803:	c3                   	ret
...
morecore(uint nu)
{
 ...
 85a:	83 c4 10             	add    $0x10,%esp
  return freep;
 85d:	a1 a8 0b 00 00       	mov    0xba8,%eax
}
 862:	c9                   	leave
 863:	c3                   	ret
...
malloc(uint nbytes)
{
 ...
 876:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 879:	a1 a8 0b 00 00       	mov    0xba8,%eax
 87e:	89 45 f0             	mov    %eax,-0x10(%ebp)
 881:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 885:	75 23                	jne    8aa <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 887:	c7 45 f0 a0 0b 00 00 	movl   $0xba0,-0x10(%ebp)
 88e:	8b 45 f0             	mov    -0x10(%ebp),%eax
 891:	a3 a8 0b 00 00       	mov    %eax,0xba8
 896:	a1 a8 0b 00 00       	mov    0xba8,%eax
 89b:	a3 a0 0b 00 00       	mov    %eax,0xba0
    base.s.size = 0;
 8a0:	c7 05 a4 0b 00 00 00 	movl   $0x0,0xba4
 8a7:	00 00 00 
  }
 ...
 8fd:	a3 a8 0b 00 00       	mov    %eax,0xba8
      return (void*)(p + 1);
 ...
 908:	eb 3b                	jmp    945 <malloc+0xe1>
    ...
    if(p == freep)
 90a:	a1 a8 0b 00 00       	mov    0xba8,%eax
