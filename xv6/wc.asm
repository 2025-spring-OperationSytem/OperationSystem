...
wc(int fd, char *name)
{
  ...
  32:	05 a0 09 00 00       	add    $0x9a0,%eax
  ...
  45:	05 a0 09 00 00       	add    $0x9a0,%eax
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 526:	0f b6 91 80 09 00 00 	movzbl 0x980(%ecx),%edx
...
free(void *ap)
{
 ...
 729:	a1 a8 0b 00 00       	mov    0xba8,%eax
 ...
 7f4:	a3 a8 0b 00 00       	mov    %eax,0xba8
}
 7f9:	90                   	nop
 7fa:	c9                   	leave
 7fb:	c3                   	ret
...
morecore(uint nu)
{
 ...
 852:	83 c4 10             	add    $0x10,%esp
  return freep;
 855:	a1 a8 0b 00 00       	mov    0xba8,%eax
}
 85a:	c9                   	leave
 85b:	c3                   	ret
...
malloc(uint nbytes)
{
 ...
 86e:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 871:	a1 a8 0b 00 00       	mov    0xba8,%eax
 876:	89 45 f0             	mov    %eax,-0x10(%ebp)
 879:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 87d:	75 23                	jne    8a2 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 87f:	c7 45 f0 a0 0b 00 00 	movl   $0xba0,-0x10(%ebp)
 886:	8b 45 f0             	mov    -0x10(%ebp),%eax
 889:	a3 a8 0b 00 00       	mov    %eax,0xba8
 88e:	a1 a8 0b 00 00       	mov    0xba8,%eax
 893:	a3 a0 0b 00 00       	mov    %eax,0xba0
    base.s.size = 0;
 898:	c7 05 a4 0b 00 00 00 	movl   $0x0,0xba4
 89f:	00 00 00 
  }
 ...
 8f5:	a3 a8 0b 00 00       	mov    %eax,0xba8
      return (void*)(p + 1);
 ...
 900:	eb 3b                	jmp    93d <malloc+0xe1>
    ...
    if(p == freep)
 902:	a1 a8 0b 00 00       	mov    0xba8,%eax
