...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3de:	0f b6 91 08 08 00 00 	movzbl 0x808(%ecx),%edx
...
free(void *ap)
{
 ...
 5e1:	a1 24 08 00 00       	mov    0x824,%eax
 ...
 6ac:	a3 24 08 00 00       	mov    %eax,0x824
}
 6b1:	90                   	nop
 6b2:	c9                   	leave
 6b3:	c3                   	ret
...
morecore(uint nu)
{
 ...
 70a:	83 c4 10             	add    $0x10,%esp
  return freep;
 70d:	a1 24 08 00 00       	mov    0x824,%eax
}
 712:	c9                   	leave
 713:	c3                   	ret
...
malloc(uint nbytes)
{
 ...
 726:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 729:	a1 24 08 00 00       	mov    0x824,%eax
 72e:	89 45 f0             	mov    %eax,-0x10(%ebp)
 731:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 735:	75 23                	jne    75a <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 737:	c7 45 f0 1c 08 00 00 	movl   $0x81c,-0x10(%ebp)
 73e:	8b 45 f0             	mov    -0x10(%ebp),%eax
 741:	a3 24 08 00 00       	mov    %eax,0x824
 746:	a1 24 08 00 00       	mov    0x824,%eax
 74b:	a3 1c 08 00 00       	mov    %eax,0x81c
    base.s.size = 0;
 750:	c7 05 20 08 00 00 00 	movl   $0x0,0x820
 757:	00 00 00 
  }
 ...
 7ad:	a3 24 08 00 00       	mov    %eax,0x824
      return (void*)(p + 1);
 ...
 7b8:	eb 3b                	jmp    7f5 <malloc+0xe1>
    ...
    if(p == freep)
 7ba:	a1 24 08 00 00       	mov    0x824,%eax
