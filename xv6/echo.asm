...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3d6:	0f b6 91 00 08 00 00 	movzbl 0x800(%ecx),%edx
...
free(void *ap)
{
 ...
 5d9:	a1 1c 08 00 00       	mov    0x81c,%eax
 ...
 6a4:	a3 1c 08 00 00       	mov    %eax,0x81c
}
 6a9:	90                   	nop
 6aa:	c9                   	leave
 6ab:	c3                   	ret
...
morecore(uint nu)
{
 ...
 702:	83 c4 10             	add    $0x10,%esp
  return freep;
 705:	a1 1c 08 00 00       	mov    0x81c,%eax
}
 70a:	c9                   	leave
 70b:	c3                   	ret
...
malloc(uint nbytes)
{
 ...
 71e:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 721:	a1 1c 08 00 00       	mov    0x81c,%eax
 726:	89 45 f0             	mov    %eax,-0x10(%ebp)
 729:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 72d:	75 23                	jne    752 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 72f:	c7 45 f0 14 08 00 00 	movl   $0x814,-0x10(%ebp)
 736:	8b 45 f0             	mov    -0x10(%ebp),%eax
 739:	a3 1c 08 00 00       	mov    %eax,0x81c
 73e:	a1 1c 08 00 00       	mov    0x81c,%eax
 743:	a3 14 08 00 00       	mov    %eax,0x814
    base.s.size = 0;
 748:	c7 05 18 08 00 00 00 	movl   $0x0,0x818
 74f:	00 00 00 
  }
 ...
 7a5:	a3 1c 08 00 00       	mov    %eax,0x81c
      return (void*)(p + 1);
 ...
 7b0:	eb 3b                	jmp    7ed <malloc+0xe1>
    ...
    if(p == freep)
 7b2:	a1 1c 08 00 00       	mov    0x81c,%eax
