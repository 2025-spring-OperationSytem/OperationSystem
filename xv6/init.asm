...
printint(int fd, int xx, int base, int sgn)
{
 ...
 46a:	0f b6 91 e4 08 00 00 	movzbl 0x8e4(%ecx),%edx
...
free(void *ap)
{
 ...
 66d:	a1 00 09 00 00       	mov    0x900,%eax
 ...
 738:	a3 00 09 00 00       	mov    %eax,0x900
}
 73d:	90                   	nop
 73e:	c9                   	leave
 73f:	c3                   	ret
...
morecore(uint nu)
{
 ...
 796:	83 c4 10             	add    $0x10,%esp
  return freep;
 799:	a1 00 09 00 00       	mov    0x900,%eax
}
 79e:	c9                   	leave
 79f:	c3                   	ret
...
malloc(uint nbytes)
{
 ...
 7b2:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 7b5:	a1 00 09 00 00       	mov    0x900,%eax
 7ba:	89 45 f0             	mov    %eax,-0x10(%ebp)
 7bd:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 7c1:	75 23                	jne    7e6 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 7c3:	c7 45 f0 f8 08 00 00 	movl   $0x8f8,-0x10(%ebp)
 7ca:	8b 45 f0             	mov    -0x10(%ebp),%eax
 7cd:	a3 00 09 00 00       	mov    %eax,0x900
 7d2:	a1 00 09 00 00       	mov    0x900,%eax
 7d7:	a3 f8 08 00 00       	mov    %eax,0x8f8
    base.s.size = 0;
 7dc:	c7 05 fc 08 00 00 00 	movl   $0x0,0x8fc
 7e3:	00 00 00 
  }
 ...
 839:	a3 00 09 00 00       	mov    %eax,0x900
      return (void*)(p + 1);
 ...
 844:	eb 3b                	jmp    881 <malloc+0xe1>
    ...
    if(p == freep)
 846:	a1 00 09 00 00       	mov    0x900,%eax
