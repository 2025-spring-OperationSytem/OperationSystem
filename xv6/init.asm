...
printint(int fd, int xx, int base, int sgn)
{
 ...
 472:	0f b6 91 ec 08 00 00 	movzbl 0x8ec(%ecx),%edx
...
free(void *ap)
{
 ...
 675:	a1 08 09 00 00       	mov    0x908,%eax
 ...
 740:	a3 08 09 00 00       	mov    %eax,0x908
}
 745:	90                   	nop
 746:	c9                   	leave
 747:	c3                   	ret
...
morecore(uint nu)
{
 ...
 79e:	83 c4 10             	add    $0x10,%esp
  return freep;
 7a1:	a1 08 09 00 00       	mov    0x908,%eax
}
 7a6:	c9                   	leave
 7a7:	c3                   	ret
...
malloc(uint nbytes)
{
 ...
 7ba:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 7bd:	a1 08 09 00 00       	mov    0x908,%eax
 7c2:	89 45 f0             	mov    %eax,-0x10(%ebp)
 7c5:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 7c9:	75 23                	jne    7ee <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 7cb:	c7 45 f0 00 09 00 00 	movl   $0x900,-0x10(%ebp)
 7d2:	8b 45 f0             	mov    -0x10(%ebp),%eax
 7d5:	a3 08 09 00 00       	mov    %eax,0x908
 7da:	a1 08 09 00 00       	mov    0x908,%eax
 7df:	a3 00 09 00 00       	mov    %eax,0x900
    base.s.size = 0;
 7e4:	c7 05 04 09 00 00 00 	movl   $0x0,0x904
 7eb:	00 00 00 
  }
 ...
 841:	a3 08 09 00 00       	mov    %eax,0x908
      return (void*)(p + 1);
 ...
 84c:	eb 3b                	jmp    889 <malloc+0xe1>
    ...
    if(p == freep)
 84e:	a1 08 09 00 00       	mov    0x908,%eax
