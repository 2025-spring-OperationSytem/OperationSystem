...
printint(int fd, int xx, int base, int sgn)
{
 ...
 47a:	0f b6 91 f4 08 00 00 	movzbl 0x8f4(%ecx),%edx
...
free(void *ap)
{
 ...
 67d:	a1 10 09 00 00       	mov    0x910,%eax
 ...
 748:	a3 10 09 00 00       	mov    %eax,0x910
}
 74d:	90                   	nop
 74e:	c9                   	leave
 74f:	c3                   	ret
...
morecore(uint nu)
{
 ...
 7a6:	83 c4 10             	add    $0x10,%esp
  return freep;
 7a9:	a1 10 09 00 00       	mov    0x910,%eax
}
 7ae:	c9                   	leave
 7af:	c3                   	ret
...
malloc(uint nbytes)
{
 ...
 7c2:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 7c5:	a1 10 09 00 00       	mov    0x910,%eax
 7ca:	89 45 f0             	mov    %eax,-0x10(%ebp)
 7cd:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 7d1:	75 23                	jne    7f6 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 7d3:	c7 45 f0 08 09 00 00 	movl   $0x908,-0x10(%ebp)
 7da:	8b 45 f0             	mov    -0x10(%ebp),%eax
 7dd:	a3 10 09 00 00       	mov    %eax,0x910
 7e2:	a1 10 09 00 00       	mov    0x910,%eax
 7e7:	a3 08 09 00 00       	mov    %eax,0x908
    base.s.size = 0;
 7ec:	c7 05 0c 09 00 00 00 	movl   $0x0,0x90c
 7f3:	00 00 00 
  }
 ...
 849:	a3 10 09 00 00       	mov    %eax,0x910
      return (void*)(p + 1);
 ...
 854:	eb 3b                	jmp    891 <malloc+0xe1>
    ...
    if(p == freep)
 856:	a1 10 09 00 00       	mov    0x910,%eax
