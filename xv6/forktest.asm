...
printf(int fd, char *s, ...)
{
  ...
  write(fd, s, strlen(s));
   ...
   d:	ff 75 0c             	push   0xc(%ebp)
  10:	e8 9c 01 00 00       	call   1b1 <strlen>
  15:	83 c4 10             	add    $0x10,%esp
  18:	83 ec 04             	sub    $0x4,%esp
  1b:	50                   	push   %eax
  1c:	ff 75 0c             	push   0xc(%ebp)
  1f:	ff 75 08             	push   0x8(%ebp)
